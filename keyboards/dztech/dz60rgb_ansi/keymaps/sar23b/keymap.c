...
*  uses capslock key to enter RGB and power Layer 
 ...
 * |---------+----+----+-+------++-----+------+------+------+-----------+-+------+------+-+------+------|
 * |   Ctrl |   GUI   |    Alt  |                 Space                |  AltG  |   FN   |  NUM |ADJUST| 
 * `----------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_60_ansi(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_RALT, FN,    NUM,   ADJUST
),
/* FN
 * ,----------------------------------------------------------------------------------------------------.
...
[_ADJUST] = LAYOUT_60_ansi(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  QK_BOOT, _______
),
/* Numpad 
 * ,----------------------------------------------------------------------------------------------------.
...
[_NUMPAD] = LAYOUT_60_ansi(
  KC_NUM, KC_PSLS, KC_PSLS, KC_PEQL, KC_PDOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
